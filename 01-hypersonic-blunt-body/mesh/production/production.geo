// ============================================================
// Project 01 (reset) - PRODUCTION mesh. Identical geometry to the
// validated Shakedown A mesh (full near-wall resolution, fine
// far-field: SizeMin=4.5mm/SizeMax=40mm) - checkMesh-verified clean
// in both the prior repository's Stage 2 and this repository's
// Shakedown A/B. No new mesh design needed; only the OpenFOAM case
// (freestream M=7, validated Mach-ramp startup) is new.
// ============================================================
