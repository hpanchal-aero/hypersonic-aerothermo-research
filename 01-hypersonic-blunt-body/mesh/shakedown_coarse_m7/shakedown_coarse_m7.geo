// ============================================================
// Project 01 (reset) - Shakedown B mesh: full M=7 severity,
// coarser unstructured far-field only. Near-body + buffer-ring
// geometry is BYTE-IDENTICAL to Shakedown A (validated O-grid
// design) - only the far-field background field sizing changes
// (SizeMin 4.5mm->9mm, SizeMax 40mm->80mm), per explicit decision.
// ============================================================
...
// ============================================================
// Buffer ring (byte-identical to Shakedown A)
// ============================================================
...
// ============================================================
// Unstructured far-field - COARSENED for Shakedown B
// (SizeMin 4.5mm->9mm, SizeMax 40mm->80mm; DistMax unchanged)
// ============================================================
...
Field[2] = Threshold;
Field[2].InField = 1;
Field[2].SizeMin = 9e-3;
Field[2].SizeMax = 0.08;
Field[2].DistMin = 0;
Field[2].DistMax = 0.4;
...
// ---- Diagnostic: verify outFarfield[] indices for THIS coarsened mesh ----
...
// Stage 2 verification (same topology, coarsening doesn't change patch
// ordering): outlet=outFarfield[6], farfield_outer=outFarfield[7],
